...
The main page implements the application UI including the `VideoBrush` which
...
implements all the effects of the application. `TexturePage` contains a simple
selection UI to pick a texture for the blending operation.
...
https://github.com/nokia-developer/real-time-blend-demo/blob/master/Licence.txt


6. Version history
-------------------------------------------------------------------------------

* 1.0.0.0: First public release of Real-time Blend Demo
